...
<head>
	<meta charset="UTF-8">
	<title>@yield('page_title', 'Halaman Wajib Pajak') | Pajak Bumi Bangunan</title>
        		...
        		<ul class="sidebar-menu">
        			...
        			<li class="active treeview">
              			...
              			<ul class="treeview-menu">
				            ...
				            <li class=""><a href='{{url("index")}}'><i class="fa fa-circle-o"></i> Daftar Wajib Pajak</a></li>
                    <li class=""><a href='{{url("objek")}}'><i class="fa fa-circle-o"></i> Letak Objek Pajak</a></li>
                    <li class=""><a href='{{url("asetbg")}}'><i class="fa fa-circle-o"></i> Aset Bangunan</a></li>
                    <li class=""><a href='{{url("asetth")}}'><i class="fa fa-circle-o"></i> Aset Tanah</a></li>
                    <li class=""><a href='{{url("tagih")}}'><i class="fa fa-circle-o"></i> Tagihan Anda</a></li>
